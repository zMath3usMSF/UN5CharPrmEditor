    ...
    public partial class UpdateMatch : Form
    {
        ...
        public void SendText(bool isP1)
        {
            ...
            if (processHandle != IntPtr.Zero)
            {
                ...
                IntPtr PlayerOffset = (IntPtr)(isP1 == true ? 0x20BD7AAC  + Main.memoryDif : 0x20BD7AD4  + Main.memoryDif);
                ...
                Main.ReadProcessMemory(processHandle, (IntPtr)0x20BD7AF8 + Main.memoryDif, MapIDByte, MapIDByte.Length, out var none5);
